...
Public Class BlockChain
    ...
    Public Event NewTransactionsFetched(newTransactionsCount As Long, newTransferTransactions As List(Of TransferTransaction))
    ...
    Protected Overridable Function parseBlockChain(Optional blockToStart As Long = -1) As Boolean
        ...
        If newTransactionsCount > 0 Then
            RaiseEvent NewTransactionsFetched(newTransactionsCount, newTransferTransactions)
        End If
